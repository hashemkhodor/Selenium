...
class Product(object):
    def __init__(self,name,link=None,keyword=None,price=[],deliveryoptions=None,deliveryprice=['Unavaible'],deliverytime=['Unavailable'],overview='',features='',criticalreviews='',goodreviews='',generalreviews='',rating='',details=''):
        self.name=name
        self.price=price
